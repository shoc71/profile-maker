...
while True:
    ...
    LOWERCASE_LETTERS[fourth_letter_pos]
    ...
    (third_letter_pos >= (len(LOWERCASE_LETTERS) - 1)) and \
    (fourth_letter_pos >= (len(LOWERCASE_LETTERS) - 1)):
        
        three_letter_combo.append("Zzzz")
    ...
    if (third_letter_pos > (len(LOWERCASE_LETTERS) - 1)) and \
    (fourth_letter_pos > (len(LOWERCASE_LETTERS) - 1)):
        # three_letter_combo.append(word)
        fourth_letter_pos = 0
        third_letter_pos = 0
    ...
    if (fourth_letter_pos > (len(LOWERCASE_LETTERS) - 1)):
        # three_letter_combo.append(word)
        fourth_letter_pos = 0
        third_letter_pos += 1
